//! Instance and GPU context management for OrbitKV.
//!
...
use crate::{EngineError, TransferMode, transfer::worker::GpuWorkerPool};
...
impl GpuContext {
    ...
    fn new(
        ...
        let worker_pool = GpuWorkerPool::new(device_id, numa_node, transfer_mode)?;
...
#[cfg(test)]
#[path = "../../tests/unit/engine/instance.rs"]
mod tests;
