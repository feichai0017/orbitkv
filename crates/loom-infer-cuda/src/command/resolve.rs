...
impl CommandScope<'_> {
    ...
    pub(crate) fn resolve_rrrw<A, B, C, D>(
        &mut self,
        first: Read<A>,
        second: Read<B>,
        third: Read<C>,
        fourth: Write<D>,
    ) -> Result<ResolvedRrrw<'_, A, B, C, D>, CommandError>
    where
        A: ResolveElement,
        B: ResolveElement,
        C: ResolveElement,
    ...
    #[allow(clippy::too_many_arguments, clippy::type_complexity)]
    pub(crate) fn resolve_rrrrrrrrww<A, B, C, D, E, F, G, H, I, J>(
        &mut self,
        first: Read<A>,
        second: Read<B>,
        third: Read<C>,
        ...
        ninth: Write<I>,
        tenth: Write<J>,
    ) -> Result<ResolvedRrrrrrrrww<'_, A, B, C, D, E, F, G, H, I, J>, CommandError>
    where
        A: ResolveElement,
        B: ResolveElement,
        C: ResolveElement,
...
#[allow(clippy::type_complexity)]
pub(crate) struct ResolvedRrrrrrrrww<
    'scope,
    A: BindingElement,
    B: BindingElement,
    C: BindingElement,
...
> {
    ...
    pub(crate) sixth: &'scope DeviceRegion<F>,
    pub(crate) seventh: &'scope DeviceRegion<G>,
    pub(crate) eighth: &'scope DeviceRegion<H>,
    pub(crate) ninth: &'scope mut ReadWriteDeviceRegion<I>,
    pub(crate) tenth: &'scope mut ReadWriteDeviceRegion<J>,
}
