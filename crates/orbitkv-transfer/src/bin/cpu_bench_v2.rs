...
fn main() {
    ...
    println!(
        "orbitkv-cpu-bench-v2: memory={:?} block_size={} blocks_per_task={} tasks={} warmup={} pool_size={} hugepages={}",
        cli.memory,
        cli.block_size,
        cli.blocks_per_task,
        cli.tasks,
...
fn create_engine_context(
    group: &TopologyGroup,
    domains: Vec<orbitkv_transfer::v2::DomainInfo>,
    memory: MemoryKind,
    buf_size: usize,
    use_hugepages: bool,
) -> EngineContext {
