...
trait Scalar: Copy {
    ...
    fn top_p_renorm<S: CudaStreamHandle>(
        backend: &CudaBackend<S>,
        logits: &mut DeviceSliceMut<'_, Self>,
        top_ps: &DeviceSlice<'_, f32>,
        probabilities: &mut DeviceSliceMut<'_, f32>,
    ...
    (
        ...
        impl Scalar for $scalar {
            ...
            fn top_p_renorm<S: CudaStreamHandle>(
                ...
                backend.$top_p_renorm(logits, top_ps, probabilities, workspace, spec, layout)
            }
