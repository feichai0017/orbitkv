...
use orbitkv_cuda::{cudarc, cudarc::driver::CudaContext, runtime::CudaRuntime};
...
/// Row-gather/scatter idioms shared with orbitkv_ops::attention (must match
...
fn main() {
    ...
    for seed in 0..seeds {
        orbitkv_compiler::mask_events::reset();
