use super::cublaslt::try_create_cublaslt;
pub mod decode;
pub mod fused;
...
impl GLUMoE {
    ...
    fn get_kernels(
        ...
        self.module.get_or_init(|| {
            let src = include_str!("moe/routing.cu");
...
impl EgglogOp for GLUMoE {
    ...
    fn rewrites(&self) -> Vec<Rule> {
        vec![
            Rule::raw(include_str!("moe/leading_dimensions.egg")),
            Rule::raw(include_str!["moe/glumoe_rewrite.egg"]),
        ]
    }
