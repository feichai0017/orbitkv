...
impl EgglogOp for BlockScaledQuantize {
    ...
    fn extract<'a>(
        ...
        crate::providers::provider_source::validate_provider_identity(&provider, &current)
        ...
        unsafe {
            stream
                ...
                .launch(LaunchConfig {
                    ...
                    block_dim: (contract::QUANTIZER_THREADS as u32, 1, 1),
                    shared_mem_bytes: 0,
                })?;
        }
        Ok(())
...
#[cfg(test)]
#[path = "../../../tests/unit/providers/deepgemm/shared/mod.rs"]
mod tests;
