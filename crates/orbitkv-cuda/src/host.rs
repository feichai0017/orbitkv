...
/// Allocation owners retained by the exact child graph that captured them.
/// Ownership is opaque to the runtime; byte accounting stays in the host's
/// existing device-memory plan.
