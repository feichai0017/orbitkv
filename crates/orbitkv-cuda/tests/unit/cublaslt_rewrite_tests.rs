...
// serialized CUDA unit-test runtime. Use `cargo test -p orbitkv-cuda -- --ignored`
...
#[test]
#[ignore = "expensive CUDA rewrite sweep; run with cargo test -p orbitkv-cuda -- --ignored"]
...
#[test]
#[ignore = "expensive CUDA rewrite regression; run with cargo test -p orbitkv-cuda -- --ignored"]
...
#[test]
#[ignore = "expensive CUDA negative rewrite sweep; run with cargo test -p orbitkv-cuda -- --ignored"]
...
#[test]
#[ignore = "expensive CUDA FP8 rewrite sweep; run with cargo test -p orbitkv-cuda -- --ignored"]
...
#[test]
#[ignore = "expensive CUDA functional candidate sweep; run with cargo test -p orbitkv-cuda -- --ignored"]
