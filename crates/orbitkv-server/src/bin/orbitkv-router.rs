//! OrbitKV P/D Disaggregation Router
//!
...
#[derive(Parser)]
#[command(name = "orbitkv-router")]
#[command(version)]
#[command(about = "OrbitKV P/D Disaggregation Router")]
struct Args {
    /// Host to bind
...
#[tokio::main]
async fn main() {
    orbitkv_common::logging::init_stderr("info");
    info!("Starting orbitkv-router v{}", env!("CARGO_PKG_VERSION"));
