...
pub(crate) fn register_hll_gauges(tracker: &Arc<Mutex<MultiWindowHllTracker>>) {
    ...
    HLL_GAUGES.get_or_init(|| {
        ...
        let cardinality = meter
            .f64_observable_gauge("orbitkv_hll_cardinality")
        ...
        let total_requests = meter
            .u64_observable_gauge("orbitkv_hll_total_requests")
        ...
        let estimated_hit_rate = meter
            .f64_observable_gauge("orbitkv_hll_estimated_hit_rate")
...
impl RpcMetrics {
    fn new() -> Self {
        let meter = global::meter("orbitkv_server_rpc");
        let request_count = meter
            .u64_counter("orbitkv_rpc_requests")
            .with_description("Total RPC requests handled by orbitkv server")
            .build();
        let request_duration = meter
            .f64_histogram("orbitkv_rpc_duration")
