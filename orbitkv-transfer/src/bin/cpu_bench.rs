...
use clap::Parser;
use log::warn;
use orbitkv_common::read_cpu_topology_from_sysfs;
use orbitkv_transfer::rdma_topo::SystemTopology;
use orbitkv_transfer::{MemoryRegion, TransferDesc, TransferEngine, TransferOp, init_logging};
...
fn main() {
    ...
    println!(
        "orbitkv-cpu-bench: block_size={} blocks_per_task={} tasks={} warmup={} pool_size={} hugepages={}",
        cli.block_size,
        cli.blocks_per_task,
        cli.tasks,
        cli.warmup_tasks,
