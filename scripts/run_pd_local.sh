...
DECODE_KV_CONFIG='{"kv_connector":"PdConnector","kv_role":"kv_both","kv_connector_module_path":"orbitkv.vllm.pd","engine_id":"d0","kv_connector_extra_config":{"orbitkv.pd.mooncake.bind_host":"127.0.0.1","orbitkv.pd.mooncake.rank_map":{"0":{"nic":"mlx5_1"}}}}'
PREFILL_KV_CONFIG='{"kv_connector":"PdConnector","kv_role":"kv_both","kv_connector_module_path":"orbitkv.vllm.pd","engine_id":"p0","kv_connector_extra_config":{"orbitkv.pd.mooncake.bind_host":"127.0.0.1","orbitkv.pd.mooncake.rank_map":{"0":{"nic":"mlx5_2"}}}}'
...
"$VENV/python" -m orbitkv.vllm.pd.proxy \
