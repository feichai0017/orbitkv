...
| Fixed-signature decode CUDA Graph | L3 + narrow L4 correctness; L5 failed | Generic stable-input replay and a released-checkpoint lifecycle pass on H20; a 20-iteration matched diagnostic found flattened replay 24.9% slower than eager materialized-graph dispatch |
