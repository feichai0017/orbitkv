...
| sampling and log probabilities | `sampling.rs` | `sampling_dispatch.rs` | `cuda/sampling_bridge.rs` | `greedy_sample.cu` · `token_penalties.cu` | `sampling.cpp` | `vllm/sampling.py` |
