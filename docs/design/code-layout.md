...
| --- | --- | --- | --- | --- | --- | --- |
| normalization | `norm.rs` | `norm_dispatch.rs` | `cuda/norm_bridge.rs` | `rms_norm.cu` · `add_rms_norm.cu` · `rms_norm_quant.cu` | `norm.cpp` | `vllm/norm.py` · `vllm/_rms_int8_fusion.py` |
