...
| sampling and log probabilities | `sampling.rs` | `sampling_dispatch.rs` | `cuda/sampling_bridge.rs` | `sample_logprobs.cu` · `token_penalties.cu` | `sampling.cpp` | `vllm/sampling.py` |
