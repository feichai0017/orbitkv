...
ABI9 wheels. The current `7df4133` ABI9 artifact packages the final adapter and
passes the full vLLM 0.24/0.25 plus PyTorch 2.10/2.11 matrix. The `e2c2982`
ABI8 artifact and the refreshed `f98a931` and cross-matrix `d58ebf8` ABI7
...
later ABI7 refresh and ABI8/ABI9 matrix wheels package that adapter; this does
not change the candidate's quality rejection.
