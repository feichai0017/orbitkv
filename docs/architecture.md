...
| [LMCache MP serialization](https://docs.lmcache.ai/mp/serde.html) and [FlexKV compression](https://github.com/taco-project/FlexKV/tree/738ddc141a198b4e20de6c5d1f0128e387f7fdb2/flexkv/transfer/compression) | Separate engine precision from cache encoding; bound codec workspace and qualify formats | `backing/ssd/codec` owns optional Rust LZ4, scratch permits and checksum validation; the existing SSD index/writer/reader own representation and I/O. GPU codecs and lossy storage quantization remain future work. |
