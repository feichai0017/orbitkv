...
- `--storage-codec-budget`: GPU workspace per active transfer worker (default 64 MB),
  separate from encoded pinned residency. ANS needs nvCOMP 5.3; FP8 has an AVX2 CPU fallback.
