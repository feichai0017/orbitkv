...
The final Manager gate covers SSD reads during a held write completion,
...
qualification are recorded separately in [storage formats](storage-formats.md#qualification).
