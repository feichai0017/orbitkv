...
Decoder artifact schema 9 records explicit attention algorithms and the updated
provider ABI. Schema 8 and earlier artifacts must be regenerated by fresh search. CUDA module integrity, target and
