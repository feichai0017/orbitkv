...
| LZ4 read canceled, mixed raw/encoded prefix or corrupted file | Scratch survives submitted I/O, both representations restore byte-exactly, damaged decodes become misses and scratch returns to zero. |
