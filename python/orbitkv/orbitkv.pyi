...
class OrbitKVRdmaV1Handshake:
    status: str
    has_metadata: bool
    @property
    def metadata(self) -> bytes | None: ...

class OrbitKVRdmaV1Engine:
    ...
    def prepare_handshake(self, remote_addr: str) -> OrbitKVRdmaV1Handshake: ...
...
class EngineRpcClient:
    """gRPC client for remote OrbitKVEngine server communication.
    ...
    def __init__(self, endpoint: str | None = None) -> None:
        ...
        Raises:
            OrbitKVError: If connection to the server fails.
        """
        ...
    ...
    def register_context_batch(
        ...
        Raises:
            OrbitKVError: If server is unavailable.
    ...
    def start_session_watcher(
        ...
        Raises:
            OrbitKVError: If the server is unavailable.
