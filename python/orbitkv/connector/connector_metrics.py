"""
Metrics collection and Prometheus integration for OrbitKV KV connector.
"""
...
@dataclass
class OrbitKVConnectorStats(KVConnectorStats):
    """Stats for OrbitKV KV connector.
    ...
    def aggregate(self, other: "OrbitKVConnectorStats") -> "OrbitKVConnectorStats":
    ...
    def clone_and_reset(self) -> "OrbitKVConnectorStats":
...
class OrbitKVPromMetrics(KVConnectorPromMetrics):
    """Prometheus metrics for OrbitKV KV connector."""
    ...
    def __init__(
        ...
        gauge_pending_prefetches = self._gauge_cls(
            name="vllm:orbitkv_pending_prefetches",
        ...
        gauge_pending_save_requests = self._gauge_cls(
            name="vllm:orbitkv_pending_save_requests",
        ...
        histogram_prefetch_duration = self._histogram_cls(
            name="vllm:orbitkv_prefetch_duration_seconds",
        ...
        histogram_prefetch_blocks = self._histogram_cls(
            name="vllm:orbitkv_prefetch_blocks",
        ...
        histogram_load_duration = self._histogram_cls(
            name="vllm:orbitkv_load_duration_seconds",
        ...
        histogram_save_duration = self._histogram_cls(
            name="vllm:orbitkv_save_duration_seconds",
