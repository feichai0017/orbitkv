---
name: version-bump
description: Bump orbitkv-llm package version. Use when the user asks to bump version, release a new version, increment version, or update package version.
---

# Version Bump

Bump the `orbitkv-llm` Python package version by directly editing `python/pyproject.toml`.
