...
wire_layout!(OrbitKvStatePoolConfig, 32, 8; engine_epoch = 0, pool_epoch = 8, byte_count = 16, pool_id = 24, slot_count = 28);
wire_layout!(OrbitKvStateSlotLease, 32, 8; engine_epoch = 0, pool_epoch = 8, generation = 16, slot_id = 24, pool_id = 28);
wire_layout!(OrbitKvStateTransitionLease, 16, 8; engine_epoch = 0, slot = 8, generation = 12);
wire_layout!(OrbitKvStateRetirementLease, 16, 8; engine_epoch = 0, slot = 8, generation = 12);
wire_layout!(OrbitKvStatePoolIdentity, 32, 8; engine_epoch = 0, pool_epoch = 8, byte_count = 16, pool_id = 24, slot_count = 28);
wire_layout!(OrbitKvStatePoolStats, 104, 8; identity = 0, free_slots = 32, reserved_slots = 40, relocating_slots = 48, live_slots = 56, retiring_slots = 64, quarantined_slots = 72, active_owners = 80, pending_transitions = 88, pending_retirements = 96);
wire_layout!(OrbitKvStatePrepareItem, 48, 8; owner_id = 0, expected = 8, expected_present = 40, reserved = 44);
wire_layout!(OrbitKvStateCopyIntent, 104, 8; transition = 0, owner_id = 16, source = 24, destination = 56, byte_count = 88, source_present = 96, reserved = 100);
wire_layout!(OrbitKvStateCopyReceipt, 96, 8; transition = 0, source = 16, destination = 48, byte_count = 80, source_present = 88, observed = 89, written = 90, reserved8 = 91, reserved32 = 92);
wire_layout!(OrbitKvStateCompletionReceipt, 32, 8; engine_epoch = 0, completion_domain = 8, completion_value = 16, confirmed = 24, reserved = 28);
wire_layout!(OrbitKvStateRetirementCertificate, 72, 8; retirement = 0, slot = 16, byte_count = 48, completion_domain = 56, completion_value = 64);
wire_layout!(OrbitKvStatePublication, 120, 8; owner_id = 0, slot = 8, retirement = 40, retirement_present = 112, reserved = 116);
wire_layout!(OrbitKvStateAbortItem, 24, 8; transition = 0, backend_unobserved = 16, reserved = 20);
wire_layout!(OrbitKvStateRetireOwnerItem, 40, 8; owner_id = 0, expected = 8);
wire_layout!(OrbitKvStateCurrent, 48, 8; owner_id = 0, slot = 8, present = 40, reserved = 44);
